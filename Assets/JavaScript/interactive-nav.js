    ...
    const categoryData = {
      "metal-wall-art": {
        subcategories: [
          ...
          { name: "Nature-Inspired (Trees, Leaves, Flowers)", url: "metal-nature.html" },
          { name: "Industrial & Rustic Metal Art", url: "metal-minimalist.html" },
          { name: "Personalized & Custom Metal Signs", url: "metal-geometric.html" }
        ],
      ...
      "wallpapers": {
        subcategories: [
          ...
          { name: "Textured Wallpapers (Brick, Wood, Marble, etc.)", url: "wallpaper-floral.html" },
      ...
      "wall-shelves": {
        subcategories: [
          ...
          { name: "Wall Shelves with Hooks & Storage", url: "shelves-modern.html" }
        ],
      ...
      "wall-mounted-animals": {
        subcategories: [
          ...
          { name: "Artistic & Abstract Animal Designs", url: "animals-minimalist.html" }
        ],
